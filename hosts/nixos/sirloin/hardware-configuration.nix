...
# system" assertion so `nix flake check` can evaluate this host. It does
# not point at a real device and must be replaced along with the rest of
# this file before this host is ever built or deployed.
_: {
  fileSystems."/" = {
